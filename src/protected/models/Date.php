...
class Date extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('appointments', 'numerical', 'integerOnly'=>true),
			array('date_begin, date_end', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id_date, date_begin, date_end, appointments', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'appointments0' => array(self::HAS_MANY, 'Appointment', 'id_date'),
		);
	}
