...
class Teachers extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_teacher', 'numerical', 'integerOnly'=>true),
			array('firstName, lastName', 'length', 'max'=>45),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id_teacher, firstName, lastName', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'appointments' => array(self::HAS_MANY, 'Appointment', 'id_teacher'),
			'teacherClasses' => array(self::HAS_MANY, 'TeacherClasses', 'id_teacher'),
		);
	}
