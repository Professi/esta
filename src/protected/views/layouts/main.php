...
$menu = array( //icon,label,url,visible(bool)
    array('fi-home', Yii::t('app','Ihre Termine'), array('Appointment/index'), ! Yii::app()->user->isAdmin() && Yii::app()->user->checkAccessRole("2", "3")),
    array('fi-calendar', Yii::t('app','Termine vereinbaren'), array('Appointment/getTeacher'), Yii::app()->user->checkAccess('3') && !Yii::app()->user->isAdmin()),
    array('fi-plus', Yii::t('app','Termine anlengen'), array('Appointment/create'), Yii::app()->user->checkAccessNotAdmin('2') && Yii::app()->params['teacherAllowBlockTeacherApps']),
    array('fi-lock', Yii::t('app','Termine blockieren'), array('Appointment/createBlockApp'), Yii::app()->user->checkAccessNotAdmin('2') && Yii::app()->params['allowBlockingAppointments'] && !(Yii::app()->params['allowBlockingOnlyForManagement'])),
    array('fi-widget', Yii::t('app','Elternsprechtage'), array('Date/admin'), Yii::app()->user->checkAccess('0')),
    array('fi-calendar', Yii::t('app','Termine'), array('Appointment/admin'), Yii::app()->user->checkAccess('1')),
    array('fi-torsos', Yii::t('app','Eltern und Kinder'), array('ParentChild/admin'), Yii::app()->user->checkAccess('1')),
    array('fi-heart', Yii::t('app','Ihre Kinder'), array('ParentChild/index'), Yii::app()->user->checkAccess('3') && !Yii::app()->user->isAdmin()),
    array('fi-torso', Yii::t('app','Benutzer'), array('User/admin'), Yii::app()->user->checkAccess('1')),
    array('fi-torsos-all', Yii::t('app','Gruppen'), array('Group/admin'), Yii::app()->user->checkAccess('1') && Yii::app()->params['allowGroups']),
    array('fi-key', Yii::t('app','Tan'), array('Tan/genTans'), Yii::app()->user->checkAccessRole('2', '1') || Yii::app()->user->isAdmin()),
    array('fi-wrench', Yii::t('app','Konfiguration'), array('site/config'), Yii::app()->user->checkAccess('0')),
    array('fi-torso', Yii::t('app','Ihr Benutzerkonto'), array('User/account'), ! Yii::app()->user->checkAccess('0')),
    array('fi-torso-business', Yii::t('app','Ihr Benutzerkonto'), array('User/account'), Yii::app()->user->checkAccess('0')),
