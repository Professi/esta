                ...
                <div class="three columns">
                    ...
                    $this->widget('zii.widgets.CMenu', array(
                        ...
                        'items' => array(//0=Administration 1=Verwaltung 2= Lehrer 3=Eltern
                            array('label' => '<span class="nav-icons" aria-hidden="true" data-icon="&#xe002;">&nbsp;Ihre Termine</span>', 'url' => array('/Appointment/index',), 'visible' => Yii::app()->user->checkAccess('3') || Yii::app()->user->checkAcces('2')),
                            array('label' => '<span class="nav-icons" aria-hidden="true" data-icon="&#xe00b;">&nbsp;Termine vereinbaren</span>', 'url' => array('/Appointment/create'), 'visible' => !Yii::app()->user->checkAccess('2')),
                            ...
                            array('label' => 'Eltern und Kinder', 'url' => array('/ParentChild/admin'), 'visible' => Yii::app()->user->checkAccess('1')),
