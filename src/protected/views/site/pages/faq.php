...
<div class="row">
    <div class="twelve columns">
        ...
        <hr>
        <h4 class="small subheader" id="Q1">Wie registriere ich mich?</h4>
        <p>
...
Nachdem Sie alle Felder ausgefüllt haben, müssen Sie auf den Button mit der Aufschrift „Registrieren“ klicken. Danach erhalten Sie eine E-Mail, die einen Registrierungslink beinhaltet. Wenn diese E-Mail eingetroffen ist, müssen Sie den mitgeschickten Link anklicken, um den Account zu aktivieren. Anschließend können Sie sich mit Ihrer E-Mailadresse und dem von Ihnen festgelegten Passwort auf der Hauptseite einloggen.
        ...
        <h4 class="small subheader" id="Q2">Was mache ich, wenn ich mein Passwort vergessen habe?</h4>
        <p>
        ...
        <h4 class="small subheader" id="Q3">Wie kann ich Schüler hinzufügen?</h4>
        <p>
        ...
        <h4 class="small subheader" id="Q4">Wie kann ich meine Benutzerdaten ändern?</h4>
        <p>
        ...
        <h4 class="small subheader" id="Q5">Wie kann ich einen Termin vereinbaren?</h4>
        <p>
        ...
        <?php if (Yii::app()->user->checkAccess('3') || Yii::app()->user->isGuest()) { ?>
            <h4 class="small subheader" id="Q6">Wie kann ich einen Termin löschen?</h4>
            <p>
        ...
        <?php } else { ?>
            <h4 class="small subheader" id="Q7">Wie kann ich einen Termin löschen?</h4>
            <p>
        ...
        <?php } ?>
        <h4 class="small subheader" id="Q8">Wie kann ich meine Termine drucken?</h4>
        <p>
        ...
        <h4 class="small subheader" id="Q9">Wie kann ich die Schule kontaktieren?</h4>
        <p>
