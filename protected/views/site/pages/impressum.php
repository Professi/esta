...
<div class="row">
    ...
    ?>
        ...
        <p><?php echo Yii::t('app', 'Diese Seite wurde mit Hilfe der folgenden Ressourcen entwickelt und erstellt:'); ?><br>
            ...
            <p>
                <b><?php echo Yii::t('app', '1. Inhalt des Onlineangebotes')?></b> <br>
                <?php echo Yii::t('app', 'Der Autor übernimmt keinerlei Gewähr für die Aktualität, Korrektheit, Vollständigkeit oder Qualität der bereitgestellten Informationen. Haftungsansprüche gegen den Autor, welche sich auf Schäden materieller oder ideeller Art beziehen, die durch die Nutzung oder Nichtnutzung der dargebotenen Informationen bzw. durch die Nutzung fehlerhafter und unvollständiger Informationen verursacht wurden, sind grundsätzlich ausgeschlossen, sofern seitens des Autors kein nachweislich vorsätzliches oder grob fahrlässiges Verschulden vorliegt. 
                Alle Angebote sind freibleibend und unverbindlich. Der Autor behält es sich ausdrücklich vor, Teile der Seiten oder das gesamte Angebot ohne gesonderte Ankündigung zu verändern, zu ergänzen, zu löschen oder die Veröffentlichung zeitweise oder endgültig einzustellen.'); ?>
            </p>
            <p>
                <b><?php echo Yii::t('app', '2. Verweise und Links'); ?></b> <br>
            ...
            <p>
                <b><?php echo Yii::t('app', '3. Urheber- und Kennzeichenrecht'); ?></b> <br>
            ...
            <p>
                <b><?php echo Yii::t('app', '4. Datenschutz'); ?></b> <br>
            ...
            <p>
                <b><?php echo Yii::t('app', '5. Rechtswirksamkeit dieses Haftungsausschlusses'); ?></b> <br>
